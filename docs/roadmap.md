...
- [ ] 6b: DiariZen (diarizer). Checked again on 2026-09-16: still a pyannote fork pinned to torch 2.1.1 and non-commercial weights, so it needs a port, a separate environment or a subprocess. Best open numbers though (AMI-SDM 14.0 %, VoxConverse 9.2 %).
