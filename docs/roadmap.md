...
- [ ] Say what a run needs and why it can run out of memory, instead of recommending models. 11 GB minus about 1 GB for the desktop doesn't fit an LLM next to the speech models. Measured peaks: whisper large-v3-turbo 4.4 GB, Parakeet 9.2 to 9.6 GB, Sortformer 5.1 GB at 300 s pieces (2.0 GB at 150 s), community-1 6.1 GB, DiariZen 6.8 GB. An 8B model at Q4 wants roughly 6 GB on top of that, so with Parakeet it never fits and with whisper it's tight.
