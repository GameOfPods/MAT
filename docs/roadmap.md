...
- [ ] Extra speakers left over after linking: `sortformer.merge-threshold` joins speakers that sound alike over all their audio. Pick a value from the link x merge sweep, then check on a real episode.
